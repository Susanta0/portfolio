...
export default function LookingGlass(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/models/looking-transformed.glb')
    ...
    >
      <group name="Sketchfab_Scene">
        ...
        <mesh
          ...
          material={materials.volume_light}
          position={[-0.242, 0.098, -0.033]}
          rotation={[0.001, 0.056, 1.498]}
          scale={0.001}
        />
      </group>
    </group>
...
useGLTF.preload('/models/looking-transformed.glb')
