...
export default function About() {
  return (
    ...
    <div className="relative w-full h-screen flex flex-col items-center justify-center">
      ...
      <h1 className="font-bold text-6xl xs:text-7xl smLtext-8xl lg:text-9xl text-accent">Susanta</h1>
      <p className="font-light text-foreground text-lg">Meet the Susanta behind this portfolio</p>
      </div>
     
    </div>
      {/* <div className="border -mt-80">
        <ProfilePic/>
      </div> */}
